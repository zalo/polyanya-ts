require_relative 'rcgal_apollonius'

ag = CGAL::Apollonius_graph.new
#ag.insert('Hallo', 0.1, 0.1, 2.1)
ag.insert('Hallo', 0, 0, 2.2)
ag.insert('Rem', 1.6, 1.6, 0.2)
#
ag.insert('Bye', 3.0001, 3, 2)

puts "size: ", ag.size

puts '--'

ag.convex_hull{|el| puts el}


ag.clear
ag.insert('Up', 0, 0, 0.1)
ag.insert('Down', 1.6, 1.6, 0.2)
ag.insert('X', 1.4, 1.4, 0.1)
puts '--'
...
a = ag.convex_hull_array
puts a.class, a.size, a

puts 'yyy'

p e.to_a
exit
puts (CGAL::Apollonius_graph.instance_methods - Object.methods).sort
=begin
clear
convex_hull
convex_hull_each
